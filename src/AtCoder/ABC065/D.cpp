...
/**
 * D - Built?
 * https://atcoder.jp/contests/abc065/submissions/4230770
 * クラスカル法で解いた。
 * 最小全域木を求める問題であることは見ればわかるが、辺を減らす工夫が必要。
 *  (s, i) < (t, j) < (u, k) のとき1番目と3番目を結ぶ代わりに１番目と2番目の辺と2番目と3番目の辺を使えばいい。
 * x, y座標それぞれでソートしたものから辺を選んでいき最小全域木を求める。
 */
void solve() {
